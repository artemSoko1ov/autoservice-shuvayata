...
const dateCards = [
  ...
  },
  {
    icon: <Icon4/>,
    title: 'Автоэлектрика',
    description: 'Ремонт генераторов, стартеров, установка сигнализаций и электрики.',
  },
  {
    icon: <Icon5/>,
    title: 'Автозвук и мультимедиа',
    description: 'Установка акустики, сабвуферов, мультимедиа и шумоизоляция салона.',
  },
  {
    icon: <Icon6/>,
    title: 'Empty',
